    ...
    <div class="project-list">
        ...
        <ul class="starred-projects" v-if="clientsWithStarredProjects">
            <template v-for="client in clientsWithStarredProjects">
                ...
                >
                    <span class="status-indicator starred" v-bind:class="{ online: project.metadata.online }"></span>
                    <h3>{{ project.name }}</h3>
                </li>
            </template>
        </ul>
            ...
            <li class="client" v-for="client in clientsWithNonStarredProjects">
                ...
                <ul>
                    <li
                        ...
                        v-bind:class="{ selected: selectedProject === project }"
                    >
                        <span class="status-indicator" v-bind:class="{ online: project.metadata.online }"></span>
                        <h3>{{ project.name }}</h3>
                    </li>
                </ul>
            </li>
